import sys
sys.path.append("/workspace/competitions/AIC_2025/SIU_ChillOut/Main_Source/Shot_Detection")
import os
import torch
import numpy as np
import tqdm
...
class ShotDetection:
    ...
    def __init__(self, choice: str = 'autoshot'):
        ...
        if self.choice == 'autoshot':
            self.model = AutoShot("/workspace/competitions/AIC_2024/SIU_Kitty/github/Shot_Detection/AutoShot/model_weight/ckpt_0_200_0.pth")
        else:
